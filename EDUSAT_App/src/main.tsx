...
import {SectionOneConnected,SectionTwoConnected,SectionThreeConnected} from "./App"
...
//CONNECTING REACT-REDUX TO THE HTML
//These sections will get placed wherever the div with the matching id is set up in index.html
const sectionOneElement = document.getElementById("sectionOneName");
ReactDOM.render(
...
const sectionTwoElement = document.getElementById("sectionTwoName");
ReactDOM.render(
  <Provider store={store}>
    <SectionTwoConnected />
  </Provider>,
...
const sectionThreeElement = document.getElementById("sectionThreeName");
ReactDOM.render(
  <Provider store={store}>
    <SectionThreeConnected />
  </Provider>,
  sectionThreeElement
)
