...
SystemStatus::SystemStatus()
{
    ...
    mode = true;
    mux = new Mux(MUX_SIZE, MUX_PIN_1, MUX_PIN_2, MUX_PIN_3, MUX_PIN_4, MUX_PIN_D);
}
...
// Multiplex Class
// =================
MultiPlex::MultiPlex(int size, uint8_t sig1, uint8_t sig2, uint8_t sig3, uint8_t sig4, uint8_t data)
{
    muxSize = size;
    controlPins[0] = sig1;
    controlPins[1] = sig2;
