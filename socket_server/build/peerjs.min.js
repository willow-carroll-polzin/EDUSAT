...
})(
    {
        EgBh: [
            function (require, module, exports) {
                ...
                "undefined" != typeof window && (r = module.exports.BlobBuilder = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder),
                    ...
                    (r.prototype.unpack_string = function (t) {
                        for (var e, i, r = this.read(t), n = 0, u = ""; n < t; )
                            (e = r[n]) < 128
                                ...
                                : (192 ^ e) < 32
                                ? ((i = ((192 ^ e) << 6) | (63 & r[n + 1])), (u += String.fromCharCode(i)), (n += 2))
                                : ((i = ((15 & e) << 12) | ((63 & r[n + 1]) << 6) | (63 & r[n + 2])), (u += String.fromCharCode(i)), (n += 3));
            ...
            function (require, module, exports) {
                ...
                function p(e) {
                    ...
                    if (t.mozGetUserMedia) (n.browser = "firefox"), (n.version = o(t.userAgent, /Firefox\/(\d+)\./, 1));
                        ...
                        (n.browser = "chrome"), (n.version = o(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
                        ...
                        var i = e.detectBrowser(r),
                                        ...
                                        if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                                            ...
                                            if (void 0 !== n.ideal) {
                                                ...
                                                "number" == typeof n.ideal
                                                    ? ((a[i("min", t)] = n.ideal), r.optional.push(a), ((a = {})[i("max", t)] = n.ideal), r.optional.push(a))
                                                    : ((a[i("", t)] = n.ideal), r.optional.push(a));
                                            }
                                            void 0 !== n.exact && "number" != typeof n.exact
                                                ? ((r.mandatory = r.mandatory || {}), (r.mandatory[i("", t)] = n.exact))
                            ...
                            c = function (e, r) {
                                ...
                                if ((e = JSON.parse(JSON.stringify(e))) && "object" === o(e.audio)) {
                                    ...
                                    c((e = JSON.parse(JSON.stringify(e))).audio, "autoGainControl", "googAutoGainControl"),
                                ...
                                if (e && "object" === o(e.video)) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            "environment" === d.exact || "environment" === d.ideal ? (u = ["back", "rear"]) : ("user" !== d.exact && "user" !== d.ideal) || (u = ["front"]),
                                            u)
                                        )
                                            return t.mediaDevices.enumerateDevices().then(function (t) {
                                                ...
                                                return (
                                                    !o && t.length && u.includes("back") && (o = t[t.length - 1]),
            ...
            function (require, module, exports) {
                ...
                function f(e) {
                    ...
                    e.RTCPeerConnection.prototype.addTrack = function (e, r) {
                        ...
                        return (
                            this._shimmedLocalStreams[r.id] ? -1 === this._shimmedLocalStreams[r.id].indexOf(n) && this._shimmedLocalStreams[r.id].push(n) : (this._shimmedLocalStreams[r.id] = [r, n]),
                            n
                        );
                    };
                ...
                function u(t) {
                    ...
                    if ((!t.RTCPeerConnection && t.webkitRTCPeerConnection && (t.RTCPeerConnection = t.webkitRTCPeerConnection), t.RTCPeerConnection)) {
                        ...
                        t.RTCPeerConnection.prototype.addIceCandidate = function () {
                            return arguments[0]
                                ? r.version < 78 && arguments[0] && "" === arguments[0].candidate
                                    ? Promise.resolve()
                                    : n.apply(this, arguments)
            ...
            function (require, module, exports) {
                ...
                (r.localCName = r.generateIdentifier()),
                        ...
                        for (var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, n = r.splitLines(e)[0].split(" "), a = 3; a < n.length; a++) {
                            ...
                            if (i) {
                                ...
                                switch (
                                    ...
                                    (p.rtcpFeedback = r.matchPrefix(e, "a=rtcp-fb:" + s + " ").map(r.parseRtcpFb)),
                                    t.codecs.push(p),
                                    p.name.toUpperCase())
                                ) {
                                    case "RED":
                    ...
                    (r.parseMsid = function (e) {
                        ...
                        return a.length > 0 ? { stream: (t = a[0].value.split(" "))[0], track: t[1] } : void 0;
                    }),
                        ...
                        if (
                            ...
                            (s += "a=" + i),
                                ...
                                e.sendEncodingParameters[0].rtx &&
                                    ((s += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + i),
        ...
        NJ2u: [
            function (require, module, exports) {
                ...
                function t(e) {
                    return (
                        { inboundrtp: "inbound-rtp", outboundrtp: "outbound-rtp", candidatepair: "candidate-pair", localcandidate: "local-candidate", remotecandidate: "remote-candidate" }[e.type] ||
                        e.type
                    );
                }
                    ...
                    if (
                        ...
                        (s += "a=" + c),
                            ...
                            t.sendEncodingParameters[0].rtx &&
                                ((s += "a=ssrc:" + t.sendEncodingParameters[0].rtx.ssrc + " " + c),
                    ...
                    Object.defineProperty(f.prototype, "localDescription", {
                        ...
                        (f.prototype.addTrack = function (e, t) {
                            ...
                            return (
                                ...
                                -1 === this.localStreams.indexOf(t) && this.localStreams.push(t),
                                (r.track = e),
                                (r.stream = t),
                        ...
                        (f.prototype.setLocalDescription = function (t) {
                            ...
                            if (!i("setLocalDescription", t.type, s.signalingState) || s._isClosed)
                                return Promise.reject(o("InvalidStateError", "Can not set local " + t.type + " in state " + s.signalingState));
                            if ("offer" === t.type)
                                ...
                                r.forEach(function (t, r) {
                                    ...
                                    if (!(e.isRejected(t) && 0 === e.matchPrefix(t, "a=bundle-only").length) && !i.rejected) {
                                        ...
                                        c && (v.role = "server"),
                                            (s.usingBundle && 0 !== r) || (s._gather(i.mid, r), "new" === d.state && d.start(o, u, c ? "controlling" : "controlled"), "new" === p.state && p.start(v));
                                        var h = a(l, f);
                            ...
                            return (
                                ...
                                "offer" === t.type ? s._updateSignalingState("have-local-offer") : s._updateSignalingState("stable"),
                                Promise.resolve()
                            );
                        }),
                        (f.prototype.setRemoteDescription = function (t) {
                            var r = this;
                            if (-1 === ["offer", "answer"].indexOf(t.type)) return Promise.reject(o("TypeError", 'Unsupported type "' + t.type + '"'));
                            if (!i("setRemoteDescription", t.type, r.signalingState) || r._isClosed)
                                return Promise.reject(o("InvalidStateError", "Can not set remote " + t.type + " in state " + r.signalingState));
                            var n = {};
                                        ...
                                        if (
                                            ...
                                            if ("answer" === t.type && !g) {
                                                (P = (C = r.transceivers[o]).iceGatherer),
                                                    ...
                                                    (m && 0 !== o) || ("new" === w.state && w.start(P, I, "controlling"), "new" === R.state && R.start(L)),
                                                    !a(C.localCapabilities, C.remoteCapabilities).codecs.filter(function (e) {
                                                        return "rtx" === e.name.toLowerCase();
                                                    }).length &&
                                                        C.sendEncodingParameters[0].rtx &&
                                                        delete C.sendEncodingParameters[0].rtx,
                                                    r._transceive(C, "sendrecv" === S || "recvonly" === S, "sendrecv" === S || "sendonly" === S),
                        ...
                        (f.prototype.createAnswer = function () {
                            ...
                            if ("have-remote-offer" !== t.signalingState && "have-local-pranswer" !== t.signalingState)
                                return Promise.reject(o("InvalidStateError", "Can not call createAnswer in signalingState " + t.signalingState));
                            ...
                            return t && void 0 === t.sdpMLineIndex && !t.sdpMid
                                ...
                                : new Promise(function (a, i) {
                                      ...
                                      if (t && "" !== t.candidate) {
                                          ...
                                          if ((0 === c || (c > 0 && p.iceTransport !== n.transceivers[0].iceTransport)) && !s(p.iceTransport, l))
                                              return i(o("OperationError", "Can not add ICE candidate"));
                ...
                function a(n) {
                    ...
                    !n.RTCRtpSender ||
                        ...
                        Object.defineProperty(n.RTCRtpSender.prototype, "dtmf", {
                            get: function () {
                                return (
                                    void 0 === this._dtmf && ("audio" === this.track.kind ? (this._dtmf = new n.RTCDtmfSender(this)) : "video" === this.track.kind && (this._dtmf = null)), this._dtmf
                                );
                            },
                        }),
                        ...
                        if (
                            ((n.mediaDevices.getUserMedia = function (e) {
                                return (
                                    "object" === r(e) &&
                                        "object" === r(e.audio) &&
                                        ((e = JSON.parse(JSON.stringify(e))), a(e.audio, "autoGainControl", "mozAutoGainControl"), a(e.audio, "noiseSuppression", "mozNoiseSuppression")),
                                    s(e)
                                );
                            }),
                        ...
                        if (i && i.prototype.applyConstraints) {
                            ...
                            i.prototype.applyConstraints = function (e) {
                                return (
                                    "audio" === this.kind &&
                                        "object" === r(e) &&
                                        ((e = JSON.parse(JSON.stringify(e))), a(e, "autoGainControl", "mozAutoGainControl"), a(e, "noiseSuppression", "mozNoiseSuppression")),
                                    u.apply(this, [e])
                                );
                            };
                        }
                ...
                function a(n) {
                    if (n.RTCIceCandidate && !(n.RTCIceCandidate && "foundation" in n.RTCIceCandidate.prototype)) {
                        ...
                        (n.RTCIceCandidate = function (t) {
                            if (
                                ("object" === i(t) && t.candidate && 0 === t.candidate.indexOf("a=") && ((t = JSON.parse(JSON.stringify(t))).candidate = t.candidate.substr(2)),
                            ...
                            if (
                                ...
                                var n,
                                    ...
                                    a =
                                        ((p = i),
                                        (u = 65536),
                                        "firefox" === o.browser && (u = o.version < 57 ? (-1 === p ? 16384 : 2147483637) : o.version < 60 ? (57 === o.version ? 65535 : 65536) : 2147483637),
                                        u),
                                    c = (function (t, n) {
                                        var r = 65536;
                    ...
                    return (
                        ...
                        (e.prototype.isBrowserSupported = function () {
                            ...
                            return (
                                ...
                                ("chrome" === r ? e >= this.minChromeVersion : "firefox" === r ? e >= this.minFirefoxVersion : "safari" === r && !this.isIOS && e >= this.minSafariVersion)
                            );
                        }),
                    ...
                    function r() {
                        (this.CLOUD_HOST = "0.peerjs.com"),
                            ...
                            (this.supports = (function () {
                                var r,
                                    t = { browser: e.Supports.isBrowserSupported(), webRTC: e.Supports.isWebRTCSupported(), audioVideo: !1, data: !1, binaryBlob: !1, reliable: !1 };
                                if (!t.webRTC) return t;
                                try {
                                    (r = new RTCPeerConnection(o)), (t.audioVideo = !0);
                                    var n = void 0;
                                    try {
                                        (n = r.createDataChannel("_PEERJSTEST", { ordered: !0 })), (t.data = !0), (t.reliable = !!n.ordered);
                                        try {
                    ...
                    return (
                        ...
                        (r.prototype._print = function (r) {
                            ...
                            r >= o.All
                                ...
                                : r >= o.Errors && console.error.apply(console, e(["ERROR"], i));
                        }),
                        r
                    );
                })();
                    ...
                    a = (function (t) {
                        ...
                        return (
                            ...
                            (o.prototype._cleanup = function () {
                                this._socket && ((this._socket.onopen = this._socket.onmessage = this._socket.onclose = null), this._socket.close(), (this._socket = void 0)),
                    ...
                    a = (function () {
                        ...
                        return (
                            ...
                            (o.prototype._setupListeners = function (e) {
                                ...
                                r.default.log("Listening for ICE candidates."),
                                    (e.onicecandidate = function (e) {
                                        e.candidate &&
                                            e.candidate.candidate &&
                                            (r.default.log("Received ICE candidates for " + t + ":", e.candidate),
                                            s.socket.send({ type: c.ServerMessageType.Candidate, payload: { candidate: e.candidate, type: a, connectionId: o }, dst: t }));
                                    }),
                                    (e.oniceconnectionstatechange = function () {
                                        switch (e.iceConnectionState) {
                                            case "failed":
                                                r.default.log("iceConnectionState is failed, closing connections to " + t),
                                                    n.connection.emit(c.ConnectionEventType.Error, new Error("Negotiation of connection to " + t + " failed.")),
                                                    n.connection.close();
                                                break;
                                            case "closed":
                                                r.default.log("iceConnectionState is closed, closing connections to " + t),
                                                    n.connection.emit(c.ConnectionEventType.Error, new Error("Connection to " + t + " closed.")),
                                                    n.connection.close();
                                                break;
                                            case "disconnected":
                                    ...
                                    return t(this, function (t) {
                                        switch (t.label) {
                                            ...
                                            case 2:
                                                (a = t.sent()),
                                                    ...
                                                    this.connection.options.sdpTransform &&
                                                        ...
                                                        (a.sdp = this.connection.options.sdpTransform(a.sdp) || a.sdp),
                                                    (t.label = 3);
                                            case 3:
                                            ...
                                            case 4:
                                                return (
                                                    t.sent(),
                                                    r.default.log("Set localDescription:", a, "for:" + this.connection.peer),
                                                    (s = {
                                                        sdp: a,
                                                    ...
                                                    this.connection.type === c.ConnectionType.Data &&
                                                        ((d = this.connection), (s = e(e({}, s), { label: d.label, reliable: d.reliable, serialization: d.serialization }))),
                                                    o.socket.send({ type: c.ServerMessageType.Offer, payload: s, dst: this.connection.peer }),
                                                    [3, 6]
                                                );
                                            case 5:
                                                return (
                                                    "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (l = t.sent()) &&
                                                        (o.emitError(c.PeerErrorType.WebRTC, l), r.default.log("Failed to setLocalDescription, ", l)),
                                                    [3, 6]
                                                );
                                            case 6:
                                                return [3, 8];
                                        ...
                                        switch (t.label) {
                                            ...
                                            case 2:
                                                (o = t.sent()),
                                                    ...
                                                    this.connection.options.sdpTransform &&
                                                        "function" == typeof this.connection.options.sdpTransform &&
                                                        (o.sdp = this.connection.options.sdpTransform(o.sdp) || o.sdp),
                                                    (t.label = 3);
                                            case 3:
                                            ...
                                            case 4:
                                                return (
                                                    t.sent(),
                                                    r.default.log("Set localDescription:", o, "for:" + this.connection.peer),
                                                    n.socket.send({
                                                        type: c.ServerMessageType.Answer,
                                                        payload: { sdp: o, type: this.connection.type, connectionId: this.connection.connectionId, browser: i.util.browser },
                            ...
                            (o.prototype._addTracksToConnection = function (e, n) {
                                if ((r.default.log("add tracks from stream " + e.id + " to peer connection"), !n.addTrack))
                    ...
                    c = (function (r) {
                        function l(e, t, o) {
                            ...
                            return (
                                ...
                                (i.connectionId = i.options.connectionId || l.ID_PREFIX + n.util.randomToken()),
                                (i._negotiator = new a.Negotiator(i)),
                                i._localStream && i._negotiator.startConnection({ _stream: i._localStream, originator: !0 }),
                                i
                            );
                        }
                        return (
                            ...
                            (l.prototype.answer = function (e, r) {
                                ...
                                if ((void 0 === r && (r = {}), this._localStream)) i.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
                                    ...
                                    (this._localStream = e),
                                        ...
                                        this._negotiator.startConnection(t(t({}, this.options._payload), { _stream: e }));
                            ...
                            (l.prototype.close = function () {
                                this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
                                    ...
                                    this.open && ((this._open = !1), r.prototype.emit.call(this, s.ConnectionEventType.Close));
                            }),
                            (l.ID_PREFIX = "mc_"),
                            l
                        );
                    ...
                    l = (function (n) {
                        function s(e, t, l) {
                            ...
                            return (
                                ...
                                (f.connectionId = f.options.connectionId || s.ID_PREFIX + i.util.randomToken()),
                                (f.label = f.options.label || f.connectionId),
                                (f.serialization = f.options.serialization || a.SerializationType.Binary),
                                ...
                                f._negotiator.startConnection(f.options._payload || { originator: !0 }),
                                f
                            );
                        }
                        return (
                            ...
                            (s.prototype._configureDataChannel = function () {
                                var e = this;
                                (i.util.supports.binaryBlob && !i.util.supports.reliable) || (this.dataChannel.binaryType = "arraybuffer"),
                            ...
                            (s.prototype.close = function () {
                                (this._buffer = []),
                                    ...
                                    this.open && ((this._open = !1), n.prototype.emit.call(this, a.ConnectionEventType.Close));
                            }),
                                            ...
                                            case 3:
                                                throw (
                                                    ...
                                                    "/" === this._options.path &&
                                                        ...
                                                        (i = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
                                                ...
                                                if (200 !== (r = e.sent()).status) {
                                                    if (401 === r.status)
                                                        throw (
                                                            ...
                                                            new Error("It doesn't look like you have permission to list peers IDs. " + s))
                                                        );
                    ...
                    f = (function (o) {
                        function i(e, n) {
                            ...
                            return (
                                ...
                                e && e.constructor == Object ? (n = e) : e && (r = e.toString()),
                                (n = t({ debug: 0, host: s.util.CLOUD_HOST, port: s.util.CLOUD_PORT, path: "/", key: i.DEFAULT_KEY, token: s.util.randomToken(), config: s.util.defaultConfig }, n)),
                                (c._options = n),
                                "/" === c._options.host && (c._options.host = window.location.hostname),
                                c._options.path &&
                                    ("/" !== c._options.path[0] && (c._options.path = "/" + c._options.path), "/" !== c._options.path[c._options.path.length - 1] && (c._options.path += "/")),
                                void 0 === c._options.secure && c._options.host !== s.util.CLOUD_HOST
                                    ? (c._options.secure = s.util.isSecure())
                                    : c._options.host == s.util.CLOUD_HOST && (c._options.secure = !0),
                                c._options.logFunction && a.default.setLogFunction(c._options.logFunction),
                                ...
                                s.util.supports.audioVideo || s.util.supports.data
                                    ? r && !s.util.validateId(r)
                                        ? (c._delayedAbort(u.PeerErrorType.InvalidID, 'ID "' + r + '" is invalid'), c)
                                        : (r
                                              ? c._initialize(r)
                                              : c._api
                                                    .retrieveId()
                                          ...
                                          c)
                                    : (c._delayedAbort(u.PeerErrorType.BrowserIncompatible, "The current browser does not support WebRTC"), c)
                            );
                        }
                        return (
                            e(i, o),
                            ...
                            (i.prototype._handleMessage = function (e) {
                                ...
                                switch (o) {
                                    ...
                                    case u.ServerMessageType.Offer:
                                        ...
                                        if (((_ = this.getConnection(s, c)) && (_.close(), a.default.warn("Offer received for existing Connection ID:" + c)), i.type === u.ConnectionType.Media))
                                            (_ = new l.MediaConnection(s, this, { connectionId: c, _payload: i, metadata: i.metadata })), this._addConnection(s, _), this.emit(u.PeerEventType.Call, _);
                                        else {
                                    ...
                                    default:
                                        ...
                                        (_ = this.getConnection(s, c)) && _.peerConnection
                                            ...
                                            : a.default.warn("You received an unrecognized message:", e);
                                }
                            }),
                            ...
                            (i.prototype.connect = function (e, t) {
                                if ((void 0 === t && (t = {}), this.disconnected))
                                    return (
                                        ...
                                        void this.emitError(u.PeerErrorType.Disconnected, "Cannot connect to new Peer after disconnecting from server.")
                                    );
                            ...
                            (i.prototype._addConnection = function (e, t) {
                                a.default.log("add connection " + t.type + ":" + t.connectionId + " to peerId:" + e),
                            ...
                            (i.prototype.reconnect = function () {
                                if (this.disconnected && !this.destroyed)
                                    a.default.log("Attempting reconnection to server with ID " + this._lastServerId), (this._disconnected = !1), this._initialize(this._lastServerId);
                                else {
